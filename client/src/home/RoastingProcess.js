    ...
    return(
        ...
        <div className={styles.roastingProcessSteps}>
            <div className={styles.processStep}>
                <img className={styles.processImage} src="/fire-solid-full.svg" alt='processStep' />
            ...
            <div className={styles.processStep}>
                <img className={styles.processImage} src="/hourglass-start-solid-full.svg" alt='processStep' />
            ...
            <div className={styles.processStep}>
                <img className={styles.processImage} src="/snowflake-regular-full.svg" alt='processStep' />
